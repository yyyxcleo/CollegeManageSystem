...
<!--      </el-form-item>-->
    ...
    <el-table v-loading="loading" :data="classList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="班级教室" align="center" prop="classRoom" />
      <el-table-column label="开课时间" align="center" prop="startTime" />
      <el-table-column label="结课时间" align="center" prop="endTime" />
      <el-table-column label="班主任" align="center" prop="classMonitor"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="班级教室" prop="classRoom">
          <el-input v-model="form.classRoom" placeholder="请输入班级教室" />
        </el-form-item>
        ...
        <el-form-item label="班主任" prop="classMonitor">
          <el-input v-model="form.classMonitor" placeholder="请输入班主任" />
        </el-form-item>
<!--        <el-form-item label="开课时间" prop="postSort">-->
